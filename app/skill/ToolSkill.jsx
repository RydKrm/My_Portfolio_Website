...
const ToolSkill = () => {
  return (
    <div className="mt-16">
            <p className='border-s-2 border-c_ternary ps-4'> Software Skill </p>
            ...
            <div className="flex flex-row justify-between w-56 mb-3">
              ...
              <div className="flex flex-row justify-between w-56 mb-3">
                <img width='32' height='32' className='text-gray-500 bg-gray-500' src="https://img.icons8.com/dotty/80/visual-studio-code-2019.png" alt="adobe-photoshop"/>
                <p className='mt-1 text-base font-semibold ms-2 me-6'>VS Code</p>
                <div className="flex flex-row mt-2">
