import { faFigma, faNode, faPhp } from '@fortawesome/free-brands-svg-icons'
...
const BackEndService = () => {
  return (
     <div className="flex flex-col pb-12 mt-4 ms-8">
      ...
      <h5 className="mt-2 uppercase">Back End Service </h5>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 lg:ms-16"> 
        ...
        <div className="pb-8 mt-8 w-80"> 
           <div className="w-full pt-1 bg-gradient-to-t from-c_secondary to-c_primary ps-8 front-service-2">
              <FontAwesomeIcon icon={faNode} className='mt-10 mb-2 text-white w-11 h-11'  />
             <h5> Backend Development  </h5>
             <p className='mb-2 p_light'> With Node.js, Express.js, MongoDB or MySQL, Firebase, RESTful API, TypeScript </p>
           </div>
           <div className="w-full pb-8 bg-white">
            <p className="pt-2 pb-5 mx-4 text-gray-600 p_light"> Develop backend for your website using Node.js, Express.js, MongoDB or MySQL.  </p>
      ...
      <div className="pb-8 mt-8 w-80"> 
           <div className="w-full pt-1 pb-5 bg-gradient-to-t from-c_secondary to-c_primary ps-8 front-service-1">
             ...
             <p className='p_light'> Using PHP, MySQL </p>
           </div>
           <div className="w-full pb-8 bg-white">
           ...
           <p className="pt-2 pb-5 mx-4 text-gray-600 p_light"> Develop backend for your website using PHP, MySQL.  </p>
            <Link href="/" className='px-5 py-2 mt-2 mb-3 text-gray-700 transition-all duration-300 border rounded-md ms-4 gradient-border hover:bg-gradient-to-r hover:from-c_primary hover:to-c_secondary hover:text-white hover:border-0'>Order Now </Link> 
           </div>
          </div>
      </div>
